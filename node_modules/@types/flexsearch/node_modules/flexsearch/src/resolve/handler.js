    ...
    for(let i = 0, query; i < args.length; i++){
        ...
        if(query){
            ...
            if(query.constructor === Resolver){
                ...
                let cache = SUPPORT_CACHE && query.cache;
                let async = SUPPORT_ASYNC && query.async;
                let index;
                ...
                if(query.query || query.tag){
                    ...
                    // TODO
                    if(async && cache){
                        result = index.searchCacheAsync(query);
                    }
                    else if(cache){
                        result = index.searchCache(query).result;
                    }
                    else if(async){
                        result = index.searchAsync(query);
                    }
                    else{
